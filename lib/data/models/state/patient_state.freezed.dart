...
class _$_PatientState implements _PatientState {
  ...
  @override
  String toString() {
    return 'PatientState(adress: $adress, age: $age, disease: $disease, name: $name, surname: $surname, appState: $appState, error: $error)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, adress, age, disease, name, surname, appState, error);
