...
abstract class $LoginStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({String email, String password, AppState appState, String error});
}
...
class _$_LoginState implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, appState: $appState, error: $error)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, appState, error);
